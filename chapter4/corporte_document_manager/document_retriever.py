...
from chapter4.corporte_document_manager.document_loader import load_document
from chapter4.corporte_document_manager.llms_embeddings import EMBEDDINGS
    ...
    def add_uploaded_docs(self, uploaded_files):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            for file in uploaded_files:
                ...
                try:
                    loaded = load_document(temp_filepath)
                    docs.extend(loaded)
                    success+=1
                except Exception as e:
                    failure+=1
                    failed_docs.extend(file.name)
